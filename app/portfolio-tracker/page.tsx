...
const features = [
  ...
  },
  {
    ...
    description:
      'Measure performance at customizable time intervals. Compare against benchmarks, track your cost basis, and analyze each holding contribution to overall returns.',
  },
  {
    tag: 'Trade Analysis',
