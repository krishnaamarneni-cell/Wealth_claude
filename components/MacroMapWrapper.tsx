                  ...
                  ranked.map((item, i) => {
                    ...
                    return (
                      <div key={item.iso} data-iso={item.iso}
                        className={`flex items - center justify - between px - 3 py - 2 cursor - pointer border - b border - border / 20 transition - colors ${
      isSel ? "bg-white/5" : "hover:bg-secondary/20"
    } `}
