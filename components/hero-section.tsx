      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
            Stocks, ETFs, and Crypto Investment Tracker with Real-Time Market Heat Maps. 
            Monitor your portfolio performance anywhere, anytime.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Button asChild size="lg" variant="outline" className="h-12 text-base border-border text-foreground hover:bg-secondary bg-transparent">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-primary" />
              <span>Support currencies worldwide</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-primary" />
