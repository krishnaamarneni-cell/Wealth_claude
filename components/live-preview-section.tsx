    ...
    <section className="relative py-32 px-6 bg-[#060a10] overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto mb-20">
          {/* Outer glow ring */}
          <div className="absolute -inset-px rounded-2xl bg-gradient-to-br from-primary/30 via-transparent to-primary/20 blur-sm" />
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/8 bg-[#0d1117]">
            ...
            <div className="relative bg-[#060a10]">
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10">
                <Link
                  href="/globe"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-black/60 backdrop-blur-sm border border-primary/30 text-primary text-sm hover:bg-black/80 hover:border-primary/50 transition-all duration-300 shadow-lg"
                >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {STEPS.map((s) => (
            <div key={s.step} className="relative group">
              ...
              <div className="relative z-10 flex flex-col gap-4 p-6 rounded-2xl border border-white/5 bg-white/2 hover:border-primary/20 hover:bg-white/3 transition-all duration-300">
