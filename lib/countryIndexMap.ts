...
export const COUNTRY_INDEX_MAP: Record<string, CountryIndex> = {
  ...
  ROU: { ticker: "^BETI", name: "BET Index", exchange: "BSE", currency: "RON" },
...
export const NO_EXCHANGE_COUNTRIES = new Set([
  ...
  "GNQ", "ERI", "SWZ", "ETH", "FJI", "GAB", "GMB", "GEO", "GHA", "GRD",
  ...
  "UZB", "VUT", "VEN", "YEM", "ZMB", "ZWE", "IRN", "CUB", "LUX", "HRV",
  "SVK", "SVN", "EST", "LVA", "LTU", "ISL", "CYP", "ALB", "ARM", "AZE",
  "BLR", "GEO", "KAZ", "KGZ", "UKR", "MKD", "SRB", "MNE", "BIH", "MDA",
])