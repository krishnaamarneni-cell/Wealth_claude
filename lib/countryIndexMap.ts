...
// All 51 tickers verified working against Yahoo Finance as of 2026-03
...
export const COUNTRY_INDEX_MAP: Record<string, CountryIndex> = {
  ...
  COL: { ticker: "^SPCOSLCP", name: "S&P Colombia Select", exchange: "BVC", currency: "COP" },
  ...
  NOR: { ticker: "OSEBX.OL", name: "OBX", exchange: "Oslo Bors", currency: "NOK" },
  ...
  PRT: { ticker: "PSI20.LS", name: "PSI-20", exchange: "Euronext", currency: "EUR" },
  GRC: { ticker: "GD.AT", name: "Athens Composite", exchange: "ATHEX", currency: "EUR" },
  POL: { ticker: "WIG20.WA", name: "WIG20", exchange: "GPW", currency: "PLN" },
  CZE: { ticker: "FPXAA.PR", name: "PX Index", exchange: "Prague SE", currency: "CZK" },
  HUN: { ticker: "^BUX.BD", name: "BUX", exchange: "BSE", currency: "HUF" },
  ROU: { ticker: "^BET.RO", name: "BET Index", exchange: "Bucharest SE", currency: "RON" },
  ...
  VNM: { ticker: "^VNINDEX.VN", name: "VN-Index", exchange: "HOSE", currency: "VND" },

  // ── Middle East & Africa (4) ──────────────────────────────
  SAU: { ticker: "^TASI.SR", name: "Tadawul All Share", exchange: "Tadawul", currency: "SAR" },
  ARE: { ticker: "FADGI.FGI", name: "FTSE ADX General", exchange: "ADX", currency: "AED" },
...
export const NO_EXCHANGE_COUNTRIES = new Set([
  "AFG", "ALB", "AND", "ATG", "BHS", "BHR", "BLZ", "BEN", "BTN", "BOL",
  "BIH", "BWA", "BRN", "BFA", "BDI", "CPV", "KHM", "CMR", "CAF", "TCD",
  "COM", "COG", "COD", "CIV", "CUB", "DJI", "DMA", "DOM", "ECU", "SLV",
  "GNQ", "ERI", "SWZ", "ETH", "FJI", "GAB", "GMB", "GEO", "GRD",
  "GTM", "GIN", "GNB", "GUY", "HTI", "HND", "IRQ", "JAM", "JOR", "LAO",
  "LBN", "LSO", "LBR", "LBY", "LIE", "MDG", "MWI", "MDV", "MLI", "MLT",
  "MHL", "MRT", "MUS", "FSM", "MDA", "MCO", "MNG", "MNE", "MOZ", "MMR",
  "NAM", "NPL", "NIC", "NER", "OMN", "PLW", "PAN", "PNG", "PRY", "PRK",
  "MKD", "STP", "SEN", "SRB", "SLE", "SLB", "SOM", "SSD", "SDN", "SUR",
  "SYR", "TJK", "TLS", "TGO", "TON", "TTO", "TKM", "TUV", "UGA", "URY",
  "UZB", "VUT", "VEN", "YEM", "ZMB", "ZWE", "IRN", "LUX", "HRV",
  "SVK", "SVN", "ISL", "CYP", "ARM", "AZE", "BLR", "BGR", "KAZ",
  "KGZ", "UKR", "PAK", "BGD", "LKA", "NGA", "KEN", "QAT", "KWT",
  "MAR", "OMN", "BHR", "SRB", "GHA", "TUN",
])